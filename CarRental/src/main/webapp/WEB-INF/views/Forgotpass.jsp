...
<body class="bodydesign">
      	...
      	<input type="text" class="i1" name="fusername"><br><br>
     <label for="password" class="label1">Email: </label> 
     <input type = "text  class = "i1" name="email"> <br><br> 
      <select name = "roles" class ="selectborder">
...
<input type="hidden" name="newoption" value="forgot">
